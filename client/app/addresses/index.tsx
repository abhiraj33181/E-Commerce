  ...
  const fetchAddresses = async () => {
    try {
      ...
      Toast.show({
        ...
        text2: error.message || "An error occurred while fetching addresses.",
      });
    } finally {
      setLoading(false);
    }
  ...
  const handleSaveAddress = async () => {
    ...
    try {
      ...
      Toast.show({
        type: "error",
        text1: "Error saving address",
        text2: error.message || "An error occurred while saving the address.",
      });
    } finally {
      setSubmitting(false);
    }
            ...
            onPress: async () => {
              try {
                ...
                Toast.show({
                  ...
                  text2: error.message || "An error occurred while deleting the address.",
                });
              }
            },
          },
